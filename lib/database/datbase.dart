...
class DatabaseHelper {
  ...
  void _createDb(Database db, int version) async {
    await db.execute(
        'CREATE TABLE $noteTable($colId INTEGER PRIMAY KEY AUTO INCREMENT, $colTitle TEXT, $colDate TEXT, $colPrioridade TEXT, $colStatus INTEGER )');
  }
  ...
  Future<List<Note>> getNoteList() async {
    ...
    noteList.sort((noteA, noteB) =>
        noteA.date!.compareTo(noteB.date!)); //ordenar a lista por data
    return noteList;
  }
